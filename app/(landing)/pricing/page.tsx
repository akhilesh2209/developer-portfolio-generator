...
function FloatingParticles() {
  const particles = useMemo(() => {
    ...
    return [...Array(8)].map((_, i) => ({
      ...
      color: i % 3 === 0 ? 'rgba(99,102,241,0.1)' : i % 3 === 1 ? 'rgba(139,92,246,0.08)' : 'rgba(6,182,212,0.06)',
      duration: 10 + random(i + 24) * 8,
      delay: random(i + 32) * 5,
    }))
  }, [])
  ...
  const faqs = [
    {
      ...
      a: 'Absolutely! You can upgrade or downgrade at any time. Changes take effect at your next billing cycle.'
    },
    {
    ...
    },
    {
      ...
      a: 'Yes! Students with a valid .edu email get 50% off the Pro plan. Contact support to verify your status.'
    },
    {
      q: 'Can I host on my own domain?',
      a: 'Pro and Enterprise plans support custom domains. We provide detailed DNS setup guides for all major registrars.'
    },
    {
      q: 'What happens to my data if I cancel?',
      a: 'Your portfolio remains downloadable. We retain your data for 30 days after cancellation in case you want to return.'
    },
  ]
      ...
      <div className="relative z-10 container mx-auto px-4 py-24 sm:py-32">
        ...
        <div className="max-w-3xl mx-auto text-center mb-16">
          <div className="inline-flex items-center gap-2 bg-gradient-to-r from-indigo-500/20 to-purple-500/20 backdrop-blur-xl rounded-full px-5 py-2 border border-indigo-500/30 shadow-lg shadow-indigo-500/10 mb-6">
            ...
            <span className="text-sm font-semibold text-indigo-300">Pricing Plans</span>
          </div>
        ...
        <div className="max-w-3xl mx-auto mb-24">
          <Card className="relative overflow-hidden border-2 border-white/10 bg-gradient-to-br from-gray-900/80 to-gray-800/60 backdrop-blur-xl">
            <div className="absolute inset-0 bg-[radial-gradient(circle_at_100%_0%,rgba(139,92,246,0.1),transparent_50%)]" />
            
            <div className="relative p-8 md:p-10 text-center">
              <div className="inline-flex items-center gap-2 bg-violet-500/10 border border-violet-500/20 rounded-full px-4 py-1.5 mb-6">
                <Users className="h-3.5 w-3.5 text-violet-400" />
                <span className="text-xs font-semibold text-violet-400">For Teams</span>
              </div>
              ...
              <p className="text-gray-400 mb-8 max-w-xl mx-auto leading-relaxed">
                We offer tailored solutions for teams and organizations with custom requirements, 
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                ...
                <Button variant="outline" size="lg" className="border-white/10 hover:border-white/20 bg-white/5 rounded-xl px-8">
                  Schedule a Demo
                </Button>
              </div>
            </div>
        ...
        <div className="max-w-3xl mx-auto">
          <div className="text-center mb-12">
            <div className="inline-flex items-center gap-2 bg-cyan-500/10 border border-cyan-500/20 rounded-full px-4 py-1.5 mb-6">
              ...
              <span className="text-xs font-semibold text-cyan-400">FAQ</span>
            </div>
          ...
          <div className="grid gap-4">
            {faqs.map((item, idx) => (
              <details key={idx} className="group">
                <summary className="flex items-center justify-between p-5 rounded-2xl border border-white/5 bg-white/[0.02] hover:border-white/10 cursor-pointer transition-all list-none">
                  <h3 className="font-semibold text-white pr-4">{item.q}</h3>
        ...
        <div className="text-center mt-24">
          ...
          <div className="flex items-center justify-center gap-4 text-sm">
            ...
            <Link href="/docs" className="text-indigo-400 hover:text-indigo-300 transition-colors font-medium">
              View Documentation →
            </Link>
          </div>
        </div>
